...
// 更新打卡统计
const updateCounts = () => {
  completedCount.value = punchLogs.value.filter((log) => log.isPunched).length;
  pendingCount.value = punchLogs.value.length - completedCount.value;
};
...
.container {
  ...
  padding: 15px;
  color: #fff;
  background: url("@/h5/static/images/Frame 2220.png") no-repeat center center;
}
